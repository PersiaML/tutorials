...
Persia runtime image can be biult from local. You can use your customized docker image to launch a PERSIA training task by both kubernetes and docker-compose.
