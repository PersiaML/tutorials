...
wget 'https://github.com/badboy/mdbook-toc/releases/download/0.7.0/mdbook-toc-0.7.0-x86_64-unknown-linux-gnu.tar.gz'
tar xzf mdbook-toc-0.7.0-x86_64-unknown-linux-gnu.tar.gz
